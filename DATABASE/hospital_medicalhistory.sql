...
CREATE TABLE `medicalhistory` (
  `MedicalHistory_id` int NOT NULL AUTO_INCREMENT,
  ...
  KEY `p_id` (`p_id`),
  CONSTRAINT `medicalhistory_ibfk_1` FOREIGN KEY (`p_id`) REFERENCES `patient` (`p_id`)
...
INSERT INTO `medicalhistory` VALUES (1,'2023-06-01',1,'NA','NA','NA');
